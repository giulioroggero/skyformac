PROJECT      := MacZWO.xcodeproj
SCHEME       := MacZWO
CONFIGURATION := Debug
DESTINATION  := platform=macOS
DERIVED_DATA := build
APP_PATH     := $(DERIVED_DATA)/Build/Products/$(CONFIGURATION)/MacZWO.app
...
## Run the unit test suite (MacZWOTests)
test:
...
help:
	...
	@echo "  make test         - run the MacZWOTests unit test suite"
	@echo "  make run          - build and launch MacZWO.app"
