...
// `AcquisitionMode` and `AcquisitionPreset` moved to `AcquisitionPreset.swift` — see that file's
// own doc comment for why (shared with the "Skyformac Remote" iOS target, which can't compile
// this file's own `PlanetaryPreset` reference below).
