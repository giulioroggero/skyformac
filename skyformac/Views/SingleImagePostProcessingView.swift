...
struct SingleImagePostProcessingView: View {
    ...
    /// propose specific adjustments, not just give generic advice (any provider whose model can
    /// see images — every cloud provider qualifies, a local Ollama model needs to itself be
    /// vision-capable) that proposes slider values for this app's own deterministic filters to
    /// apply.
